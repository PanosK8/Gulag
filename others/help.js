...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    .addField("• Developer", `\`\`\`yml\nName: baba yaga#3970 [329654748599025674]\nName Ξ pete karatsiolis [329654748599025674]\`\`\``)
    .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.gg/3MDSP7XcTD)\`**`)
